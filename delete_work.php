...
$get_user = "select * from entery where id='$user'";
...
<body>
  ...
  <div class="left_content">
	...
	margin-top:10px;
" />
          <button><a href="addin_costumer.php?cos_id=<?php echo $cos_id; ?>" style="text-decoration:none; color:#fff;">Cancel</a></button>
        </div>
  ...
  <div class="footer">
    <div align="center" class="footer_text">&copy: copyright 2023 by karking</div>
  </div>
...
z
  ...
  $delete = "delete from entery where id='$id'";

  $run_delete = mysqli_query($con, $delete);
  if ($run_delete) {

    echo "<script>confirm('Are you sure you want to delete? This action cannot be undone.')</script>";
